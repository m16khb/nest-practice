...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.verifyEmail = function (dto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        signupVerifyToken = dto.signupVerifyToken;
                        return [4 /*yield*/, this.usersService.verifyEmail(signupVerifyToken)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.usersService.login(email, password)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    UsersController.prototype.findAll = function (offset, limit) {
